 ...
 */
// Version 2.34 14 December 2020
// 2 Nov: This version changes CSAT so they are shown as raw values
// 14th Dec: Fixed NPS 0 being interpreted as null
...
function updateCSAT(chat) {
	...
	if(typeof chat.rateadvisor === 'undefined' || chat.rateadvisor.length == 0) {
		chatobj.rateadvisor = null;		
	} else {
		chatobj.rateadvisor = Number(chat.rateadvisor);
	}
	if(typeof chat.NPS === 'undefined' || chat.NPS.length == 0) {
		chatobj.NPS = null;
	} else {
